...
def jooqflyway(
    ...
    if maven_install_target == None:
        ...
        deps = [
            ...
            "@" + maven_install_target + "//:org_testcontainers_testcontainers_jdbc",
            "@" + maven_install_target + "//:org_testcontainers_testcontainers_mariadb",
            "@" + maven_install_target + "//:org_testcontainers_testcontainers_mysql",
            "@" + maven_install_target + "//:org_testcontainers_testcontainers_postgresql",
